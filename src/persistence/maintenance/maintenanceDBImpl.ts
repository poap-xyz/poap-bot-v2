...
export class MaintenanceDBImpl implements MaintenanceDB {
    ...
    async createTables(): Promise<void> {
        await this.db.task(async (t) => {
            ...
            await t.none("CREATE TABLE events ( id integer PRIMARY KEY NOT NULL DEFAULT nextval('event_id_seq'), server VARCHAR ( 50 ) NOT NULL, channel TEXT NOT NULL," +
            ...
            await t.none("CREATE TABLE codes ( code VARCHAR ( 50 ) PRIMARY KEY NOT NULL, event_id integer NOT NULL," +
            ...
            await t.none("CREATE SEQUENCE subscribed_channels_token_id_seq;");
            await t.none("CREATE TABLE subscribed_channels_token ( id integer PRIMARY KEY NOT NULL DEFAULT nextval('subscribed_channels_token_id_seq'), server VARCHAR ( 50 ) NOT NULL, channel TEXT NOT NULL," +
